...
class DDLExtractor:
    ...
    def extract(self, messages: List[Message], max_messages: int = 5000) -> List[Event]:
        """从消息中提取 DDL 事件
        
        Args:
            messages: 已解析的消息列表
            max_messages: 最多处理的消息数量
        ...
        ddl_items = self.ai_client.extract_deadlines(messages, max_messages)
